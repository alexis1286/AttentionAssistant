...
public class Observer{
	...
	/**
	 * Get Dictionary
	 * This will probably be removed later down the line, just want to 
	 * do some testing for the time being  - Jmitchel2
	 * @return Dictionary
	 */
	...
	/**
	 * Set Up for Dictionary with JWNL.
	 * This will be organized better later, but is here for testing -Jmitchel2
	 * @return Dictionary
	 */
	public Dictionary setUpDict() {
		Dictionary tempDict= null;
		try {
		File file = new File("src/main/resources/properties.xml");
		JWNL.initialize(new FileInputStream(file));
		tempDict = Dictionary.getInstance();
		} catch (Exception e) {
            System.out.println("Error while setting tempDict");
		}
		return tempDict;
	}
	/**
